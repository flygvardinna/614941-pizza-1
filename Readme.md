...
VuePizza — это веб-приложение для заказа пиццы. Сервис позволяет собрать свою собственную пиццу с любыми ингредиентами и оформить заказ. Vue 2, Vuex, тестирование Jest.
